...
export default class BlockSmokerTrait extends BlockTrait {
  public static readonly identifier = "smoker";
  public static readonly types = [BlockIdentifier.Smoker, BlockIdentifier.LitSmoker];

  public static MAX_COOKTIME = 100;
  public static MAX_BURNDURATION = 1600;
  public static MAX_BURNTIME = 1600;

  private readonly container = new BlockContainer(this.block, ContainerType.Smoker, 3);
  ...
  public onTick(_details: TraitOnTickDetails): void {
    ...
    const smeltable = ingredient ? smeltableTypes.slice(21, 29).find((entry) => entry.input === ingredient.identifier) : undefined;
    ...
    if (this.cookTime >= BlockSmokerTrait.MAX_COOKTIME) {
      this.cookTime = 0;
      this.dirty = true;
